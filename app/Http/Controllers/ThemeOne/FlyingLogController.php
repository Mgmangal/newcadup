...
class FlyingLogController extends Controller
{
    ...
    public function shortie()
    {
        ...
        $loginUserId = '';
        return view('theme-one.flying_logs.index', compact('loginUserId','pilots', 'aircrafts','flying_types','pilot_roles','passengers','pilot_role'));
    }
