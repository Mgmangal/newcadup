...
class LibraryController extends Controller
{
    ...
    public function hr_list(Request $request)
    {
        ...
        foreach ($result as $key => $value) {
            $action  = '<a href="' . route('app.library.hr_edit', $value->id) . '" class="btn btn-warning btn-sm m-1">Edit</a>';
            $action .= '<a href="javascript:void(0);" onclick="deleted(`' . route('app.library.hr_delete', $value->id) . '`);" class="btn btn-danger btn-sm m-1">Delete</a>';
    ...
    public function hr_edit($id)
    {
        ...
        $resource_types = Master::where('type', 'resource_type')->where('status', 'active')->where('is_delete', '0')->get();
        return view('library.hr_library.edit', compact('hr', 'resource_types'));
    }
    ...
    public function car()
    {
        return view('library.car_library.index');
    }
    public function car_create()
    {
        ...
        return view('library.car_library.create', compact('libraries'));
    }
    ...
    public function car_list(Request $request)
    {
        ...
        $data = array();
        foreach ($result as $key => $value) {
            $action  = '<a href="' . route('app.library.car_edit', $value->id) . '" class="btn btn-warning btn-sm m-1">Edit</a>';
            $action .= '<a href="javascript:void(0);" onclick="deleted(`' . route('app.library.car_delete', $value->id) . '`);" class="btn btn-danger btn-sm m-1">Delete</a>';
            $file = '<a target="blank" href="' . asset('uploads/library/' . $value->file) . '" class="btn btn-sm btn-primary"><i class="fas fa-lg fa-fw fa-file"></i></a>';
            $title = '<a href="' . route('app.library.library_view', ['type' => 'car', 'id' => $value->id]) . '">' . $value->title . '</a>';
            $sub_array = array();
            $sub_array[] = ++$key;
            $sub_array[] = $title;
    ...
    public function car_edit($id)
    {
        ...
        return view('library.car_library.edit', compact('car', 'libraries'));
    }
    ...
    public function fsdms_list(Request $request)
    {
        ...
        $data = array();
        foreach ($result as $key => $value) {
            $action  = '<a href="' . route('app.library.fsdms_edit', $value->id) . '" class="btn btn-warning btn-sm m-1">Edit</a>';
            $action .= '<a href="javascript:void(0);" onclick="deleted(`' . route('app.library.fsdms_delete', $value->id) . '`);" class="btn btn-danger btn-sm m-1">Delete</a>';
            $file = '<a target="blank" href="' . asset('uploads/library/' . $value->file) . '" class="btn btn-sm btn-primary"><i class="fas fa-lg fa-fw fa-file"></i></a>';
            $sub_array = array();
            $sub_array[] = ++$key;
            $sub_array[] = $value->title;
    ...
    public function fsdms_edit($id)
    {
        ...
        return view('library.fsdms_library.edit', compact('fsdms', 'libraries'));
    }
    ...
    public function generic_list(Request $request)
    {
        ...
        $data = array();
        foreach ($result as $key => $value) {
            $action  = '<a href="' . route('app.library.generic_edit', $value->id) . '" class="btn btn-warning btn-sm m-1">Edit</a>';
            $action .= '<a href="javascript:void(0);" onclick="deleted(`' . route('app.library.generic_delete', $value->id) . '`);" class="btn btn-danger btn-sm m-1">Delete</a>';
            $file = '<a target="blank" href="' . asset('uploads/library/' . $value->file) . '" class="btn btn-sm btn-primary"><i class="fas fa-lg fa-fw fa-file"></i></a>';
            $sub_array = array();
            $sub_array[] = ++$key;
            $sub_array[] = $value->title;
    ...
    public function generic_edit($id)
    {
        ...
        return view('library.generic_library.edit', compact('generic', 'libraries'));
    }
