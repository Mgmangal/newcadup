...
class LoadTrimController extends Controller
{
    public function index()
    {
        ...
        return view('load-trim.index',compact('aircrafts'));
    }
    ...
    public function apply()
    {
        $user = Auth::user();
        $aircrafts=AirCraft::all();
        return view('load-trim.create',compact('aircrafts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->remark=$reason;
        $data->save();
        return redirect()->route('app.load.trim')->with('success','Created successfully');
    }
    ...
    public function list(Request $request)
    {
        ...
        $users=LoadTrim::with('air_craft')->where('user_id',$user->id);
    ...
    public function edit($id)
    {
        ...
        return view('load-trim.edit',compact('aircrafts','data'));
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        $data->remark=$reason;
        $data->save();
        return redirect()->route('app.load.trim')->with('success','Updated successfully');
    }
    ...
    public function cancelled($id)
    {
        ...
        $model->is_delete='1';
        $model->save();
        return redirect()->route('app.load.trim')->with('success','Deleted successfully');
    }
