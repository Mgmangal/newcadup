                ...
                <div class="row m-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="booking_date" class="form-control dates" value="{{is_get_date_time_format($data->booking_date)}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Modification Date</label>
                            <input type="text" name="modification_date" class="form-control dates" value="{{is_get_date_time_format($data->modification_date)}}">
                       </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="departure_date" class="form-control dates" value="{{is_get_date_time_format($data->departure_date)}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Departure Time UTC</label>
                            <input type="text" name="departure_date_utc" class="form-control dates" value="{{is_get_date_time_format($data->departure_date_utc)}}">
                       </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Departure Time Local</label>
                            <input type="text" name="departure_date_local" class="form-control dates" value="{{is_get_date_time_format($data->departure_date_local)}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control auto_complete_input" name="total_pax"  value="{{ $data->total_pax ?? '' }}" min="0" placeholder="Total number of Passenger">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control auto_complete_input" name="pnr_status" value="{{ $data->pnr_status ?? '' }}" placeholder="Please Enter PNR Status">
                        </div>
                    </div>
                </div>
