<x-app-layout>
    ...
    <div class="modal fade" id="leaveModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('app.contract.store')}}" method="POST" id="manageForm" class="">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Contract User</label>
                            <select class="form-select" name="contract_user" id="contract_user">
    ...
    <x-slot name="js">
        ...
        function addNew() {
            ...
            $('#manageForm')[0].reset();
            $('#edit_id').val('');
            $('.modal-title').html('Add New Contract');
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $.each(response.message, function(fieldName, field) {
                            $('#manageForm').find('[name=' + fieldName + ']').addClass(
                                'is-invalid');
                            $('#manageForm').find('[name=' + fieldName + ']').after(
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#contract_type_id').val(response.data.contract_type_id);
                        $('#contract_user').val(response.data.contract_user);
