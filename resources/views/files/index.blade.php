    ...
    <div class="modal fade" id="fileModel" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('app.file.store')}}" method="POST" id="manageForm" class="">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <input type="hidden" name="edit_id" id="edit_id" />
                            <label class="form-label">File Name</label>
                            <input type="text" class="form-control" name="name" placeholder="Enter File Name" />
                        </div>
                        <div class="mb-3">
                            <label class="form-label">File Number</label>
                            <input type="text" class="form-control" name="number" placeholder="Enter File Number" />
                        </div>
                        <div class="mb-3">
                            ...
                            <select id="section" name="section" class="form-control">
                                ...
                                @php
                                    $sections = \App\Models\Master::where('type','section')->where('status','active')->where('is_delete', '0')->get();
                                @endphp
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#manageForm').find('[name=number]').val(response.data.number);
