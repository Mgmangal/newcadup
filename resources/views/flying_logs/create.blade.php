        ...
        <div class="card-body">
            <form action="{{route('app.flying-details.store')}}" method="POST" enctype="multipart/form-data" id="manageForm" autocomplete="off">
                ...
                <div class="row m-3">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control dates is_valid" tabindex="1" id="date" name="date" onchange="setDefaultDate(this.value);" placeholder="Please Enter Date" />
                            </div>
                            @error('date')
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="aircraft_id" id="aircraft_id" tabindex="2" class="form-control is_valid" onchange="getLastLocation(this.value);">
                ...
                <div class="field_wrapper">
                    <div class="add_more">
                        <div class="row m-3">
                            <div class="col-md-12 mb-3 bg-info justify-content-between d-flex">
                                <div class="form-lable p-2 text-white"><b>Sortie No. 1</b></div>
                                <!--<div class="form-label pt-1 w-75">-->
                                <!--    <select name="passenger[0][]" class="form-control selctPassenger" multiple>-->
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="pilot1_id[0]" tabindex="3" class="form-control is_valid pilots pilot1_id" onchange="changeHandlerPilotOne(this);">
                                        <option value="">Select</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="pilot1_role[0]" tabindex="4" class="form-control pilot1_role is_valid" onchange="changeHandlerRoleOne(this);">
                                        <option value="">Select</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="pilot2_id[0]" tabindex="5" id="pilot2_id" class="form-control pilot2_id pilots is_valid" onchange="changeHandlerPilotTwo(this);">
                                        <option value="">Select</option>
                                        @foreach($pilots as $pilot)
                                        <option value="{{$pilot->id}}">{{$pilot->name}}</option>
                                        @endforeach
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="pilot2_role[0]" tabindex="6" class="form-control pilot2_role is_valid" onchange="changeHandlerRoleTwo(this);">
                                        <option value="">Select</option>
                                        @foreach($pilot_roles as $pilot_role)
                                        <option value="{{$pilot_role->id}}">{{$pilot_role->name}}</option>
                                        @endforeach
                        ...
                        <div class="row m-3">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" tabindex="7" class="form-control start_sector auto_complete_input is_valid" name="fron_sector[0]" placeholder="Please Enter Source Sector">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">To Sector<span class="text-danger">*</span></label>
                                    <input type="text" tabindex="8" class="form-control to_sector auto_complete_input is_valid" name="to_sector[0]" placeholder="Please Enter Destination Sector">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="form-label">Flying Type</label>
                                    <select name="flying_type[0]" class="form-control flying_type is_valid" tabindex="9">
                                        <option value="">Select</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control auto_complete_input" name="comment[0]" tabindex="9" placeholder="Please Enter Remark">
                                </div>
                            </div>
                        </div>
                        <div class="row m-3">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control time_hhmm d_time is_valid" tabindex="10" onchange="calculateBlockTime(this);" name="d_time[0]" placeholder="HH:MM" onchange="validateDate();">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control time_hhmm a_time is_valid" tabindex="11" onchange="calculateBlockTime(this);" name="a_time[0]" placeholder="HH:MM" onchange="validateDate();" />
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control time_hhmm" name="night_time[0]" tabindex="12" placeholder="HH:MM" value="">
                                </div>
                            </div>
                        </div>
                    </div>
