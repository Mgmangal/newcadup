<x-app-layout>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{route('user.adt.report.generate')}}" class="btn btn-primary btn-sm p-2">Generate Report</a>
        </div>
        <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('user.adt.report.upload')}}" method="POST" enctype="multipart/form-data" id="uploadForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
        ...
        <script type="text/javascript">
            ...
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        url: "{{route('user.adt.report.list')}}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
