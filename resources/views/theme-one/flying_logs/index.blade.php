@extends('theme-one.layouts.app',['title' => 'Flying','sub_title'=>'Sortie'])
@section('css')
...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Sortie List</h3>
    ...
    <div class="card-body">
        <div class="row row-sm mb-5">
            <div class="col-md-1">
                ...
                <input type="text" class="form-control filters dates p-1" id="from_date" placeholder="DD-MM-YYYY"
                    autocomplete="off">
            </div>
            <div class="col-md-1">
                <label for="to_date">To Date</label>
                <input type="text" class="form-control filters dates p-1" id="to_date" placeholder="DD-MM-YYYY"
                    autocomplete="off">
            </div>
            <div class="col-md-1">
            ...
            <div class="col-md-2">
                <label for="flying_type">Crew</label>
