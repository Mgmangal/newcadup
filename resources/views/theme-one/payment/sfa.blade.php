@extends('theme-one.layouts.app', ['title' => 'Manage Library', 'sub_title' => 'SFA'])
@section('css')
...
<scrip src="{{ asset('assets/theme_one/lib/datatables.net-responsive-dt/js/responsive.dataTables.min.js') }}"></script>
...
<script>
    ...
    function dataList() {
        ...
        $('#datatableDefault').DataTable({
            ...
            ajax: {
                url: "{{route('user.payment.sfa_list')}}",
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
                    pilot,
