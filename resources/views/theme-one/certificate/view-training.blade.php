...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="planned_renewal_date" id="planned_renewal_date"
                value="{{$data->planned_renewal_date}}" />
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select class="form-control" name="aircroft_type" id="aircroft_type">
                ...
                <option {{$data->aircroft_type == $ac_type->id ? 'selected' : ''}} value="{{$ac_type->id}}">
                    {{$ac_type->name}}</option>
                @endforeach
            </select>
        </div>
