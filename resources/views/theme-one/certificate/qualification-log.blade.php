@extends('theme-one.layouts.app',['title' => 'Certificate','sub_title'=>'Qualification Log'])
@section('css')
...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Qualification Log List</h3>
...
function qualificationdataList() {
    ...
    $('#datatableQualification').DataTable({
        ...
        ajax: {
            url: "{{ route('user.ltm.monitoringQualificationList.log') }}",
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
