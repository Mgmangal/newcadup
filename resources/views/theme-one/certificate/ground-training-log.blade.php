@extends('theme-one.layouts.app',['title' => 'Certificate','sub_title'=>'Ground Training Log'])
@section('css')
...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Ground Training Log List</h3>
...
function groundtrainingdataList() {
    ...
    $('#datatableGroundTraining').DataTable({
        ...
        ajax: {
            url: "{{ route('user.ltm.monitoringGroundTrainingList.log') }}",
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
