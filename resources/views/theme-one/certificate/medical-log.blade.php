@extends('theme-one.layouts.app',['title' => 'Certificate','sub_title'=>'Medical Log'])
@section('css')
...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Medical Log List</h3>
...
function medicalDataList() {
    ...
    $('#datatableMedical').DataTable({
        ...
        ajax: {
            url: "{{ route('user.ltm.monitoringMedicalList.log') }}",
            type: 'POST',
            data: {
                "_token": "{{ csrf_token() }}",
