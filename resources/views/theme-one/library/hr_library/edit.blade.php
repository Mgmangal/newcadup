...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('user.library.hr_update',$hr->id)}}" method="POST" enctype="multipart/form-data"
            id="manageForm">
            @csrf
            @method('PUT')
            <div class="row m-3">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="resource_type" id="resource_type" class="form-control">
                            ...
                            <option @if($hr->resource_type == $resource->id) selected @endif
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="author" name="author"
                            placeholder="Please Enter Author" value="{{old('author',$hr->author)}}">
                        @error('author')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="publisher" name="publisher"
                            placeholder="Please Enter Publisher" value="{{old('publisher',$hr->publisher)}}">
                        @error('publisher')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="description" cols="30" rows="5"
                            placeholder="Please Enter Description">{{old('description',$hr->description)}}</textarea>
                        @error('description')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        @enderror
                        @if(!empty($hr->file))
                        <a target="blank" href="{{asset('uploads/library/'.$hr->file)}}"
