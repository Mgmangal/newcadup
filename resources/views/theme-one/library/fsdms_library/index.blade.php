...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">FSDMS Library List</h3>
        <a href="{{route('user.library.fsdms_create')}}" class="btn btn-primary btn-sm p-2">Add New</a>
    </div>
    <div class="card-body">
...
<script>
    function dataList() {
        ...
        $('#datatableDefault').DataTable({
            ...
            ajax: {
                url: "{{route('user.library.fsdms_list')}}",
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}"
                },
