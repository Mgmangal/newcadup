...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">Car Library Add</h3>
        <a href="{{url()->previous()}}" class="btn btn-primary btn-sm p-2">Back</a>
    </div>
    <div class="card-body">
        <form action="{{route('user.library.car_store')}}" method="POST" enctype="multipart/form-data" id="manageForm">
            @csrf
            <div class="row m-3">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            placeholder="Please Enter Library Name" value="{{old('title')}}">
                        @error('title')
