@extends('theme-one.layouts.app',['title' => 'Flying','sub_title'=>'My Shortie List'])
@section('css')
...
<div class="card">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title">My Shortie List</h3>
    ...
    <div class="card-body">
        <div class="row row-sm mb-3">
            ...
            <div class="col-md-1">
                ...
                <input type="text" class="form-control filters auto_complete_input p-1" id="to_sector" placeholder="" autocomplete="off">
            </div>
            <div class="col-md-2">
...
<script>
    ...
    function dataList() {
        ...
        $('#datatableDefault').DataTable({
            ...
            ajax: {
                url: "{{route('user.flying.myShortieList')}}",
                type: "post",
                data: {
                    "_token": "{{ csrf_token() }}",
