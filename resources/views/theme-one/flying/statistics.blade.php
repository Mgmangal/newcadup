@extends('theme-one.layouts.app',['title' => 'FLYING','sub_title'=>$sub_title])
@section('css')
...
<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <label for="pilot" class="form-label">Poilot</label>
            ...
            <div class="col-md-2">
                <div class="form-group mt-4">
                    <button class="btn btn-primary btn-sm btn-block ms-2 mt-2" onclick="printReport();">Print</button>
                </div>
            </div>
        </div>
...
<script>
    ...
    function dataList() {
        ...
        $('#datatableDefault').DataTable({
            ...
            ajax: {
                url: "{{route('user.flying.statisticsList')}}",
                type: 'POST',
                data: {
                    "_token": "{{ csrf_token() }}",
    ...
    function printReport() {
        ...
        if (!from_date) {
            ...
            info('Please Select Aircraft');
        } else if (!pilot) {
            info('Please Select Pilot');
        } else if (!flying_type) {
            info('Please Select Flying Type');
        }else {
            window.open("{{url('user/statistics/print')}}" + '/' + from_date + '/' + to_date + '/' + aircraft + '/' + pilot + '/' + flying_type, 'printDiv', 'height=900,width=900');
        }
    }
</script>
@endsection
