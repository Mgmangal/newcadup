@extends('theme-one.layouts.app',['title' => 'LOAD & TRIM','sub_title'=>'ADD'])
@section('css')
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('user.loadTrim.store')}}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="row m-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="dates" name="dates" required
                                placeholder="Please Select Date" value="{{old('dates')}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="remark" name="remark"
                                placeholder="Please enter remark">{{old('remark')}}</textarea>
                        </div>
                    </div>
                </div>
