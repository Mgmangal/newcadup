<x-app-layout>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">External Flying Details List</h3>
            <a href="{{route('app.external.flying-details.create')}}" class="btn btn-primary btn-sm p-2">Add New</a>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <select class="form-control filters" id="aircraft_type">
            ...
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        ...
                        type: "post",
                        data: {
                            "_token": "{{ csrf_token() }}",from_date:$('#from_date').val(),to_date:$('#to_date').val(),aircraft_type:$('#aircraft_type').val(),pilot:$('#pilot').val(),flying_type:$('#flying_type').val()
                        },
                    },
