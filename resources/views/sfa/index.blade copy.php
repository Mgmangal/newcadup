    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-3">
		        ...
		        <div class="col-sm-2">
		            <div class="form-group">
		                ...
		                <input type="text" readonly form="sfa-form" name="from_date" class="form-control datepicker filter" id="from_date" required>
		            </div>
		        </div>
		        <div class="col-sm-2">
		            <div class="form-group">
		                <lable for="to_date">To Date</lable>
		                <input type="text" readonly form="sfa-form" name="to_date" class="form-control datepicker filter" id="to_date" required>
		            </div>
		        </div>
		    </div>
    						        ...
    						        <table id="dataTable-ct" class="table table-striped table-bordered nowrap" >
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <input type="hidden" class="certified_that" name="certified_that">
                                            </tr>
                                        </tfoot>
                                    </table> 
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
			        <form action="{{route('app.sfa.preview')}}" method="post" id="sfa-form" class="text-right">
			               @csrf
                        <input type="submit" name="submit_btn" value="Download SFA Report" class="btn btn-primary">
                    </form>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="textarea_certify_that" id="textarea_certify_that" placeholder="Enter Certify That" autocomplete="off" > </textarea>
                            </div>
                        </div>
                    </div>
                </div>
