...
<body>
    ...
    <main>
        ...
        <table style="width:100%">
            <tr>
                <td
                    style="border-left: 1px solid;border-right: 1px solid;border-bottom: 1px solid;border-top: 1px solid;">
                    <p style="display: flex; font-size: 15px;padding-left: 33px;color: #000;margin:0; padding: 5px;">
                        <span style="font-weight: 900;">Name :
                            <?php echo $pilot_name;?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
                            style="margin-left: 300px;font-weight: 900;">Designation : <?php echo $designation;?></span>
                    </p>
                </td>
            </tr>
        </table><br>
