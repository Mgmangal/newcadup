<x-app-layout>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Contract Type List </h3>
            <div>
    ...
    <div class="modal fade" id="leaveModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('app.settings.contract.type.store')}}" method="POST" id="manageForm" class="">
                    @csrf
        ...
        <script>
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        url: "{{route('app.settings.contract.type.list')}}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
            ...
            function addNew() {
                ...
                $('#manageForm')[0].reset();
                $('#edit_id').val('');
                $('.modal-title').html('Add New Contract Type');
