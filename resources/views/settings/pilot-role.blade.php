<x-app-layout>
    <x-slot name="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">PILOT ROLE</li>
        </ul>
    </x-slot>
    <x-slot name="css">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Pilot Role List </h3>
            <div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalLabel">Manage Role</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{route('app.settings.pilotrole.store')}}" method="POST" id="manageForm" class="">
                    @csrf
        ...
        <script>
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        url: "{{route('app.settings.pilotrole.list')}}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
