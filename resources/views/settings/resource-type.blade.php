<x-app-layout>
    <x-slot name="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">RESOURCE TYPE</li>
        </ul>
    </x-slot>
    <x-slot name="css">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Resource Type List </h3>
            <div>
    ...
    <div class="modal fade" id="leaveModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('app.settings.resource_type_store')}}" method="POST" id="manageForm" class="">
                    @csrf
        ...
        <script>
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        url: "{{route('app.settings.resource_type_list')}}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
