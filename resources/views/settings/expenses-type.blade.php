<x-app-layout>
    ...
    <div class="modal fade" id="expensesModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('app.settings.expensesTypeStore')}}" method="POST" id="manageForm" class="">
                    @csrf
        ...
        <script>
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        url: "{{route('app.settings.expensesTypeList')}}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
            ...
            function addNew() {
                ...
                $('#manageForm')[0].reset();
                $('#edit_id').val('');
                $('.modal-title').html('Add Expenses Type');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.modal-title').text('Edit Expenses Type');
                            $('#expensesModal').modal('show');
                        }
                    }
                });
