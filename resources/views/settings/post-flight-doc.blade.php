<x-app-layout>
    <x-slot name="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">POST FLIGHT DOC</li>
        </ul>
    </x-slot>
    <x-slot name="css">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Post Flight Doc List </h3>
            <div>
    ...
    <div class="modal fade" id="leaveModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('app.settings.postFlightDocStore')}}" method="POST" id="manageForm" class="">
                    @csrf
                    <div class="modal-body">
                        <div class="mb-3">
                            <input type="hidden" name="edit_id" id="edit_id" />
                            <label class="form-label">Post Flight Doc Name</label>
        ...
        <script>
            function dataList() {
                ...
                $('#datatableDefault').DataTable({
                    ...
                    ajax: {
                        url: "{{route('app.settings.postFlightDocList')}}",
                        type: 'POST',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
            ...
            function addNew() {
                ...
                $('#manageForm')[0].reset();
                $('#edit_id').val('');
                $('.modal-title').html('Add Post Flight Doc');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('.modal-title').text('Edit Post Flight Doc');
                            $('#leaveModal').modal('show');
                        }
                    }
                });
