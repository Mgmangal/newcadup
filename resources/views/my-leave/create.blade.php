<x-app-layout>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('app.my.leave.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row m-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="master_id" name="master_id" required>
                                ...
                                <option value="{{$leave_type->master_id}}">{{$leave_type->master->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control daterange" id="leave_dates" name="leave_dates" required placeholder="Please Select Date" value="{{old('leave_dates')}}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row m-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="reason" name="reason" placeholder="Please enter reason" >{{old('reason')}}</textarea>
                        </div>
                    </div>
                </div>
