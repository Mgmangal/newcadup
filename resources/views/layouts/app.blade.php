        ...
        <div id="sidebar" class="app-sidebar">
            <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
                <div class="menu">
                    ...
                    <div
                        class="menu-item has-sub {{ request()->routeIs('app.contract') ? 'active' : ''}}">
                        <a href="#" class="menu-link">
                            <span class="menu-icon">
                                <i class="fa fa-user-md"></i>
                            </span>
                    ...
                    <!-- Reports -->
                    <div
                        class="menu-item has-sub {{ request()->routeIs(['app.reports.vipRecency','app.reports.pilotFlyingCurrency','app.reports.pilotGroundTraining','app.external.flying-details.statistics', 'app.pilot.flyingHourMonthly', 'app.sfa', 'app.fdtl', 'app.fdtl.voilations', 'app.fdtl.voilations.report','app.flying-details.statistics', 'app.reports.aaiReports']) ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="menu-link">
                            <span class="menu-icon">
                                <i class="fa fa-cog"></i>
                            </span>
                    ...
                    <!-- Monitoring -->
                    <div
                        class="menu-item has-sub {{ request()->routeIs('app.pilot.availability')||request()->routeIs('app.air-crafts.availability')||request()->routeIs('app.fdtl.monitoring')||request()->routeIs('app.pilot.monitoring')? 'active' : ''}}">
                        <a href="#" class="menu-link">
                            <span class="menu-icon">
                                <i class="fa fa-cog"></i>
                            </span>
