<x-app-layout>
    <x-slot name="breadcrumb">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('app.pilot') }}">PILOT</a></li>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Pilot Edit</h3>
            <a href="{{ url()->previous() }}" class="btn btn-primary btn-sm p-2">Back</a>
        </div>
        <div class="card-body">
            <form action="{{ route('app.pilot.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row m-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="emp_id" name="emp_id"
                                placeholder="Please Enter Emp ID" value="{{ $user->emp_id }}">
                            @error('emp_id')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="salutation" class="form-label">Mr./Ms.<span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="salutation" name="salutation"
                                placeholder="Please Enter Salutation" value="{{ $user->salutation }}">
                            @error('name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row m-3">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="department" name="department[]" multiple
                                ...
                                @foreach ($departments as $department)
                                    <option
                                        {{ !empty($user->department) && in_array($department->id, $user->department) ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="designation" name="designation">
                                @foreach ($designations as $designation)
                                    <option
                                        {{ !empty($user->designation) && $user->designation == $designation->id ? 'selected' : '' }}
                    ...
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control dates" id="doj" name="doj"
                                value="{{ $user->doj }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="joining_type" name="joining_type">
                                ...
                                <option {{ $user->joining_type == 'Contractual' ? 'selected' : '' }}
                                    value="Contractual">
                                    Contractual</option>
                                <option {{ $user->joining_type == 'Permnent' ? 'selected' : '' }} value="Permnent">
                                    Permnent
                                </option>
                                <option {{ $user->joining_type == 'External' ? 'selected' : '' }} value="External">
                                    External
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            <label for="pre_contract_renewal_date" class="form-label">Previous Contract Renewal Date</label>
                            <input type="text" class="form-control dates" id="pre_contract_renewal_date" name="pre_contract_renewal_date"
                                value="{{ $user->pre_contract_renewal_date }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            <label for="pre_valid_up_to" class="form-label">Previous Valid up to</label>
                            <input type="text" class="form-control dates" id="pre_valid_up_to" name="pre_valid_up_to"
                                value="{{ $user->pre_valid_up_to }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            <label for="contract_renewal_date" class="form-label">Contract Renewal Date</label>
                            <input type="text" class="form-control dates" id="contract_renewal_date" name="contract_renewal_date"
                                value="{{ $user->contract_renewal_date }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            <label for="valid_up_to" class="form-label">Valid up to</label>
                            <input type="text" class="form-control dates" id="valid_up_to" name="valid_up_to"
                                value="{{ $user->valid_up_to }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="aep_type" name="aep_type">
                                <option value="">Select</option>
                                <option {{ $user->aep_type == 'Contractual' ? 'selected' : '' }} value="Contractual">
                                    Contractual</option>
                                <option {{ $user->aep_type == 'Permnent' ? 'selected' : '' }} value="Permnent">
                                    Permnent
                                </option>
                                <option {{ $user->aep_type == 'External' ? 'selected' : '' }} value="External">
                                    External
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="aep_number" name="aep_number"
                                value="{{ $user->aep_number }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            <label for="aep_expiring_on" class="form-label">AEP Expiring on</label>
                            <input type="text" class="form-control dates" id="aep_expiring_on"
                                name="aep_expiring_on" value="{{ $user->aep_expiring_on }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control dates" id="passport_validity"
                                name="passport_validity" value="{{ $user->passport_validity }}">
                        </div>
                    </div>
                    <div class="col-md-4 p-2">
                        <div class="form-group">
                            <label for="aircraft_authorisation_no" class="form-label">Aircraft Authorisation
                                Number</label>
                            <input type="text" class="form-control" id="aircraft_authorisation_no"
                                name="aircraft_authorisation_no" value="{{ $user->aircraft_authorisation_no }}">
                        </div>
                    </div>
                </div>
                <div class="row m-3">
    ...
    <x-slot name="js">
        ...
        <script>
            ...
            function getSection() {
                $.ajax({
                    url: "{{ route('app.pilot.getSection') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: $('#department').val(),
            ...
            function getJobFunction() {
                $.ajax({
                    url: "{{ route('app.pilot.getJobFunction') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: $('#section').val(),
