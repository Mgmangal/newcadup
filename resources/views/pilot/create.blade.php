<x-app-layout>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Pilot Add</h3>
            <a href="{{url()->previous()}}" class="btn btn-primary btn-sm p-2">Back</a>
        </div>
        <div class="card-body">
            <form action="{{route('app.pilot.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row m-3">
                    <div class="col-md-4">
                ...
                <div class="row m-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="email" class="form-label">Emial<span class="text-danger">*</span></label>
