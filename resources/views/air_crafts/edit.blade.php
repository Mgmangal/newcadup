<x-app-layout>
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <h3 class="card-title">Aircraft Edit</h3>
            <a href="{{url()->previous()}}" class="btn btn-primary btn-sm p-2">Back</a>
        </div>
        <div class="card-body">
            <form action="{{route('app.air-crafts.update',$aircraft->id)}}" method="POST" enctype="multipart/form-data" id="manageForm">
                @csrf
                @method('PUT')
                <div class="row m-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="aircraft_cateogry" id="aircraft_cateogry" class="form-control">
                                ...
                                <option {{$aircraft->aircraft_cateogry == 'Fixed Wing' ? 'selected':''}} value="Fixed Wing">Fixed Wing</option>
                                <option {{$aircraft->aircraft_cateogry == 'Rotor Wing' ? 'selected':''}} value="Rotor Wing">Rotor Wing</option>
                                <option {{$aircraft->aircraft_cateogry == 'Fixed Wing Simulator' ? 'selected':''}} value="Fixed Wing Simulator">Fixed Wing Simulator</option>
                                <option {{$aircraft->aircraft_cateogry == 'Rotor Wing Simulator' ? 'selected':''}} value="Rotor Wing Simulator">Rotor Wing Simulator</option>
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="aircraft_type" id="aircraft_type" class="form-control">
                                ...
                                <option {{$aircraft->aircraft_type == $master->id ? 'selected':''}} value="{{$master->id}}">{{$master->name}}</option>
                                @endforeach
                            </select>
                            @error('aircraft_type')
                            <span class="text-danger">{{$message}}</span>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="Please Enter Manufacturer" value="{{old('manufacturer',$aircraft->manufacturer)}}">
                            @error('manufacturer')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                ...
                <div class="row m-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="type_model" name="type_model" placeholder="Please Enter Type Model" value="{{old('type_model',$aircraft->type_model)}}">
                            @error('type_model')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="call_sign" name="call_sign" placeholder="Please Enter Call Sign" value="{{old('call_sign',$aircraft->call_sign)}}">
                            @error('call_sign')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                ...
                <div class="row m-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="manufacturing_year" name="manufacturing_year" placeholder="Please Enter Manufacturing Year" value="{{old('type_model',$aircraft->manufacturing_year)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select class="form-control selct2" name="pilots[]" id="pilots" class="form-control" multiple>
                                    ...
                                    <option {{!empty($aircraft->pilots)&&in_array($pilot->id,$aircraft->pilots) ? 'selected':''}} value="{{$pilot->id}}">{{$pilot->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
